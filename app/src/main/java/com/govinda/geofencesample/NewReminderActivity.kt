...
class NewReminderActivity : AppCompatActivity(), OnMapReadyCallback {

  private lateinit var map: GoogleMap

  lateinit var myRepository: ReminderData

  private var reminder = ReminderDataModel(latLng = null, radius = null, message = null)
  ...
  private fun centerCamera() {
    ...
    val zoom = intent.extras?.get(Constants.ZOOM) as Float
  ...
  private fun addReminder(reminderDataModel: ReminderDataModel) {

    myRepository.add(reminderDataModel,
        success = {
